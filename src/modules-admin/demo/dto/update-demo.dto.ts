...
import { IsString, IsNumber, IsBoolean, IsOptional, IsDateString, IsObject, IsArray, IsMongoId } from 'class-validator';

export class UpdateDemoDto extends CommonRequestInterface {
